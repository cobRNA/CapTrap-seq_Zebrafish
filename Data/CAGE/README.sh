...
# ./Data/Daniocode/CAGE/download_data.sh
...
zcat ../../Daniocode/CAGE/*bed.gz | awk '{gsub("^chrchr", "chr", $1); print }' | awk '$1 ~ /^chr[0-9XYM]{1,2}$/ {print $0}' | awk 'BEGIN {OFS="\t"} {$1=$1}1' | gzip > all_main_pseudo.bed.gz
