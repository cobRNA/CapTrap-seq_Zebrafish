...
zcat ./Data/Daniocode/polyA/*bed.gz | awk 'BEGIN{FS=OFS="\t"}$5="0"' | awk 'BEGIN{FS=OFS="\t"}$2!="-1"' | awk 'BEGIN{FS=OFS="\t"}$4=$1"|"$2"|"$3"|"$6' | sort | uniq | ./Utils/sortbed - | gzip > ./Data/polyA-sites/danRer11_polyAsites.bed.gz
